...
\node[iol](y) at (7,0){$\hat{y}$};
%
\node[iol](yd) at (8.1,+0){$\rightarrow 0,1,1,0 \,\,?$};
%
\draw[->] (x0) -- (l1p1);
\draw[->] (x0) -- (l1p2);
\draw[->] (x1) -- (l1p1);
\draw[->] (x1) -- (l1p2);
\draw[->] (l1p1) -- (l2p1)node[midway, above]{$z_1$};
\draw[->] (l1p2) -- (l2p1)node[midway, below]{$z_2$};
\draw[->] (l2p1) -- (y);
%
...
\node[hl](l2p1) at (5,0){$\sigma_{\textcolor{C1}{3}}\left({\bm{w}_{\textcolor{C1}{3}}^\mathrm{T}\bm{z} + b_{\textcolor{C1}{3}}}\right)$};
\node[iol](y) at (7,0){$\hat{y}$};
%
\node[iol](yd) at (8.1,+0){$\rightarrow 0,1,1,0 \,\,?$};
%
...
%
\draw[-{Latex[length=2mm]}] (-2.5,0) -- (2.5,0)node[below]{$\textcolor{C2}{z_1}=\textcolor{C0}{z_1}, \textcolor{C3}{z_1}$};
\draw[-{Latex[length=2mm]}] (0,0) -- (0,3.75)node[right]{$\textcolor{C2}{z_2}=\textcolor{C0}{z_2}, \textcolor{C3}{z_2}$};
%
...
\node[hl](l2p1) at (5,+1.25){$\sigma_{2}\left(\bm{w}_{21}^\mathrm{T} \bm{z}_{1} + b_{21}\right)$};
\node[hl](l2p2) at (5,-1.25){$\sigma_{2}\left(\bm{w}_{22}^\mathrm{T} \bm{z}_{1} + b_{22}\right)$};
\node[hl](lop1) at (8,0){$\hat{y} = \sigma_{o}\left({\bm{w}_{o}^\mathrm{T}\bm{z}_{2} + b_{o}}\right)$};
\node[](y) at (9.75,0){};
%
\draw[->] (x0) -- (l1p1);
\draw[->] (x0) -- (l1p2);
...
\draw[->] (l2p2) -- (lop1);
%
\draw[->] (l1p1) -- (l2p1)node[midway, above]{$z_{11}$};
\draw[->] (l1p2) -- (l2p2)node[midway, below]{$z_{12}$};
%
\draw[->] (l2p1) -- (lop1)node[midway, above]{$z_{21}$};
\draw[->] (l2p2) -- (lop1)node[midway, below]{$z_{22}$};
%
\draw[->] (lop1) -- (y)node[right]{$0,1,1,0 \,\,?$};
%
\draw [decorate,decoration={brace,amplitude=5pt}] (-0.5,2.5) -- (0.5,2.5) node [black,midway,yshift=0.4cm]{input layer};
\draw [decorate,decoration={brace,amplitude=5pt}] (1.5,2.5) -- (2.5,2.5) node [black,midway,yshift=0.4cm]{hidden layer 1};
\draw [decorate,decoration={brace,amplitude=5pt}] (4.5,2.5) -- (5.5,2.5) node [black,midway,yshift=0.4cm]{hidden layer 2};
\draw [decorate,decoration={brace,amplitude=5pt}] (7.5,2.5) -- (8.5,2.5) node [black,midway,yshift=0.4cm]{output layer};
\end{tikzpicture}
\end{center}
%
\end{frame}
