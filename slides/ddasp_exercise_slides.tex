...
\begin{axis}
[xmin=0.25, xmax=2.25, domain=0.5:2,
xticklabels={,,},
yticklabels={,,},
xlabel={$\log(\lVert \bm{y} - \bm{X}\hat{\bm{\theta}}\rVert_2^2)$},
ylabel={$\log(\lVert \hat{\bm{\theta}}\rVert_2^2)$}]
\addplot[color=black, mark=o] {exp(-(x-2)^3)};
\end{axis}
\end{tikzpicture}
\end{center}
\end{frame}
