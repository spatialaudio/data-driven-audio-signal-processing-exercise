...
\begin{frame}{Literature}
  check textbooks in our main library (check free ebbok access within uni VPN)
  \begin{itemize}
...
%
\node[hl](lop1) at (7,+2.62){$\sigma\left({\bm{w}_{\textcolor{C0}{1}\text{o}}^\mathrm{T}\bm{a} + b_{\textcolor{C0}{1}\text{o}}}\right)$};
...
%
\begin{frame}{Multiclass Classification with Hidden Layer Model}
%
\vspace{-0.25cm}
\begin{center}
\begin{tikzpicture}[scale=1, every node/.style={scale=0.8}]
...
\quad
\frac{\partial \mathcal{L}}{\hat{y}_i} = - \frac{y_i}{\hat{y}_i}
$$
